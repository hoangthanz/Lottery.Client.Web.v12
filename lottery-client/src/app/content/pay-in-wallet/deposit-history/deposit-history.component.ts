...
export class DepositHistoryComponent extends BaseComponentService implements OnInit {
  ...
  ngOnInit() {
    this.getAll_orders_deposit_pending();
    this.getAll_orders_deposit_History();

  }
  // GET DATA         transactionType:       - 0 : Nạp         3 : Rút         4: Nạp và Rút
  getAll_orders_deposit_pending() {
